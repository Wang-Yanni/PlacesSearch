...
SOURCES = \
	__init__.py \
	places_search.py places_search_dialog.py

PLUGINNAME = places_search

PY_FILES = \
	__init__.py \
	places_search.py places_search_dialog.py

UI_FILES = places_search_dialog_base.ui
...
QGISDIR=C:\Users\yanni.wang\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
